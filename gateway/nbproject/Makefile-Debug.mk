...
${OBJECTDIR}/Log.o: Log.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -Wall -MMD -MP -MF $@.d -o ${OBJECTDIR}/Log.o Log.cpp

${OBJECTDIR}/ApplicationClient.o: ApplicationClient.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -Wall -MMD -MP -MF $@.d -o ${OBJECTDIR}/ApplicationClient.o ApplicationClient.cpp

${OBJECTDIR}/IBus.o: IBus.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -Wall -MMD -MP -MF $@.d -o ${OBJECTDIR}/IBus.o IBus.cpp
