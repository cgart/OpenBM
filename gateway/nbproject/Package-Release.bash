...
cd "${TOP}"
makeDirectory "${NBTMPDIR}//usr/share/openbm/html/static"
copyFileToTmpDir "html/static/login_bg.jpg" "${NBTMPDIR}/${PACKAGE_TOP_DIR}share/openbm/html/static/login_bg.jpg" 0644

cd "${TOP}"
makeDirectory "${NBTMPDIR}//usr/share/openbm/html/static"
copyFileToTmpDir "html/static/style.css" "${NBTMPDIR}/${PACKAGE_TOP_DIR}share/openbm/html/static/style.css" 0644

cd "${TOP}"
makeDirectory "${NBTMPDIR}//usr/share/openbm/html/static"
copyFileToTmpDir "html/static/jquery.pack.js" "${NBTMPDIR}/${PACKAGE_TOP_DIR}share/openbm/html/static/jquery.pack.js" 0644

cd "${TOP}"
makeDirectory "${NBTMPDIR}//usr/share/openbm/html/static"
copyFileToTmpDir "html/static/loading.gif" "${NBTMPDIR}/${PACKAGE_TOP_DIR}share/openbm/html/static/loading.gif" 0644

cd "${TOP}"
makeDirectory "${NBTMPDIR}//usr/share/openbm/html/static"
copyFileToTmpDir "html/static/panel.jpg" "${NBTMPDIR}/${PACKAGE_TOP_DIR}share/openbm/html/static/panel.jpg" 0644

cd "${TOP}"
makeDirectory "${NBTMPDIR}//usr/share/openbm/html/static"
copyFileToTmpDir "html/static/bmw_panel.png" "${NBTMPDIR}/${PACKAGE_TOP_DIR}share/openbm/html/static/bmw_panel.png" 0644

cd "${TOP}"
makeDirectory "${NBTMPDIR}//usr/share/openbm/html"
copyFileToTmpDir "html/index.html" "${NBTMPDIR}/${PACKAGE_TOP_DIR}share/openbm/html/index.html" 0644

cd "${TOP}"
makeDirectory "${NBTMPDIR}//usr/share/openbm/html"
copyFileToTmpDir "html/login.html" "${NBTMPDIR}/${PACKAGE_TOP_DIR}share/openbm/html/login.html" 0644

cd "${TOP}"
makeDirectory "${NBTMPDIR}//usr/share/openbm/html"
copyFileToTmpDir "html/favicon.ico" "${NBTMPDIR}/${PACKAGE_TOP_DIR}share/openbm/html/favicon.ico" 0644
