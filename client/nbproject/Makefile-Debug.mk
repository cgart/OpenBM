...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/client: /usr/lib/libboost_system.a

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/client: /usr/lib/libboost_thread.a

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/client: /usr/lib/libboost_program_options-mt.a
...
${OBJECTDIR}/TCPIPClient.o: TCPIPClient.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I. -MMD -MP -MF $@.d -o ${OBJECTDIR}/TCPIPClient.o TCPIPClient.cpp
