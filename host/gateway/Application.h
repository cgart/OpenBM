...
public:
    ...
    Application(const std::string& ibusPort, const std::string& address = openbm::Address, unsigned short port = openbm::Port, unsigned maxNumClients = openbm::ServerMaxNumClients, unsigned aliveTimeout = openbm::ClientAliveTimeout);
    ~Application();
    ...
    //! Send IBus message
    void sendIBusMessage(IBus::Message* msg);
